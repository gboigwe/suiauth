  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="max-w-4xl w-full px-6 py-12 text-center">
        <h1 className="text-5xl font-extrabold mb-6 text-blue-600">SuiAuth</h1>
        <p className="text-xl text-gray-600 mb-8">
          A decentralized identity and authentication solution built on Sui blockchain
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-8">
          ...
          <Link 
            href="https://github.com/your-username/suiauth" 
            target="_blank"
